describe('Hacker Stories', () => {
  beforeEach(() => {
    ...
    }).as('getStories') /// // passando intercepct como objeto
  ...
  context('List of stories', () => {
    ...
    it('shows 20 stories, then the next 20 after clicking "More"', () => {
      ...
      }).as('getNextStories') /// // passando intercepct como objeto
  ...
  context('Search', () => {
    ...
    it.skip('types and submits the forme directly', () => {
      cy.get('#search')
      .type(newTerm)
    ...
    context('Last searches', () => {
      ...
      it('shows a max of 5 buttons for the last searched terms', () => {
        ...
        Cypress._.times(6, () => { /// função lodash ._.
          cy.get('#search')
            .clear()
